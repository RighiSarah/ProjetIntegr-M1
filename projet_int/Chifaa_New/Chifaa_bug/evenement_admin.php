			...
			<div id="body">
				...
				<?php 
					if ($_SESSION['login_role']== 1){
						echo '<div style="padding-left:9em; font-size:20px;">
								<a href="ajout_evenement.php" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-plus"></span> Ajouter un évènement</a>				
							</div>';
					}
				?>
