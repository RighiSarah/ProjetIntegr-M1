  ...
  <body>
    ...
    <div class="form_page">
      <form action="evenement_admin.php" method="post" class="event">
        <?php 
          echo"
            <input type='text' name='titre_mo' size='50' placeholder='Titre de l'événement' value='".$_POST["title_event"]."'/>
            <br/> 
            ...
            <br/>
            <input type='text' name='lieu_mo' size='50' placeholder='Lieu' value='".$_POST["lieu_event"]."'/>
            <br/>
            <input type='text' name='description_mo' size='50'  placeholder='Description de l'événement' value='".$_POST["obj_event"]."'/></li>
            <br/>
